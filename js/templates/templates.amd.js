...
templates['item'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"oso-todo-view\">\r\n    <input class=\"oso-todo-toggle\" type=\"checkbox\" "
    ...
    + "</label>\r\n    <a class=\"oso-todo-destroy\"></a>\r\n</div>\r\n<input class=\"oso-todo-edit\" type=\"text\" value=\""
    + ((stack1 = ((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\"/>";
},"useData":true});
templates['stats'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<a id=\"clear_completed\" class=\"oso-clear-completed\">Clear "
